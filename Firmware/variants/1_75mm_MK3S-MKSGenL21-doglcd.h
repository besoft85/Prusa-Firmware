...
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER
	...
	//#define REPRAP_DISCOUNT_SMART_CONTROLLER //Defined in Configuration.h
	...
	#define LCD_STR_BEDTEMP     "\x01"
	//#define LCD_STR_DEGREE      "\x02"
	//#define LCD_STR_ARROW_DOWN2 "\x02"
	#define LCD_STR_ARROW_2_DOWN "\x02"
	#define LCD_STR_THERMOMETER "\x03"
	#define LCD_STR_REFRESH     "\x04" //hardcoded into messages.c. see: MSG_REFRESH
	#define LCD_STR_UPLEVEL     "\x05"
	#define LCD_STR_FOLDER      "\x06"
	#define LCD_STR_FEEDRATE    "\x07"
	#define LCD_STR_CLOCK       "\x08"
	#define LCD_STR_CONFIRM     "\x09"

	// Maximum here is 0x1F because 0x20 is ' ' (space) and the normal charsets begin.
	// Better stay below 0x10 because DISPLAY_CHARSET_HD44780_WESTERN begins here.
	#define LCD_STR_SPECIAL_MAX '\x09'

	#define LCD_STR_ARROW_RIGHT "\xA1" //from the default character set
	#define LCD_STR_ARROW_UP    "\xA2" //from the default character set
	#define LCD_STR_ARROW_DOWN  "\xA3" //from the default character set
	#define LCD_STR_DEGREE      "\xA4" //from the default character set
...
#define X_MIN_POS -0.5 //0
#define Y_MAX_POS 212.5
#define Y_MIN_POS -3.5 //orig -4
...
//M301 P126.13 I4.30 D924.76
//M301 P39.55 I4.09 D95.57
//M301 P28.82 I3.08 D67.35
//M301 P16.13 I1.1625 D56.23
...
#else
#if defined(HEATBED_MK2B)
#define DEFAULT_bedKp 49.18 //255.75 //#define DEFAULT_bedKp 134.08 //#define  DEFAULT_bedKp 55       //97.51
#define DEFAULT_bedKi 3.80 //23.59 //#define DEFAULT_bedKi 25.18  //#define  DEFAULT_bedKi 0.5      //4.66
#define DEFAULT_bedKd 424.37 //693.17 //#define DEFAULT_bedKd 178.48 //#define  DEFAULT_bedKd 250      //510.14
...
#define PET_C_PREHEAT_HOTEND_TEMP 260
#define PET_C_PREHEAT_HPB_TEMP 80
